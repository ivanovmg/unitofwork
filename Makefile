...
tests:
	python -m pytest --cov=src/unitofwork --cov-report=term-missing --cov-report=html -v

# Run linting checks
lint:
	ruff check src/unitofwork tests

# Format code
format:
	ruff check --select I --fix  # fix imports
	ruff format src/unitofwork tests

# Check formatting without making changes
format-check:
	ruff format --check src/unitofwork tests

# Run type checking
typecheck:
	mypy src/unitofwork tests
...
coverage:
	python -m pytest --cov=src/unitofwork --cov-report=html
...
ci-test:
	python -m pytest --cov=src/unitofwork --cov-report=xml
